<?php
/**
 * Class paypPayPalPlusInvoicePdfArticleSummary
 *
 * Extend InvoicepdfArticleSummary to be able to display additional payment instructions after the article summary.
 *
...
if (class_exists('InvoicepdfArticleSummary')) {
    class paypInstallmentsInvoicePdfArticleSummary extends InvoicepdfArticleSummary
    {
